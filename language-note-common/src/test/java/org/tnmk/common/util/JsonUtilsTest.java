...
public class JsonUtilsTest {
    ...
    public void success_toJson_Null() {
        final String jsonString = ObjectMapperUtils.toJson(OBJECT_MAPPER, null);
    ...
    public void success_toJson_Blank() {
        final String str = "";
        final String jsonString = ObjectMapperUtils.toJson(OBJECT_MAPPER, str);
    ...
    public void success_toObject() {
        final Person person = (Person) ObjectMapperUtils.toObject(OBJECT_MAPPER, personJson, Person.class);
    ...
    public void success_toInputStream() {
        final InputStream inputStream = ObjectMapperUtils.toJsonInputStream(OBJECT_MAPPER, personJson);
