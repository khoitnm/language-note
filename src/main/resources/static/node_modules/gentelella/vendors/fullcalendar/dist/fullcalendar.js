...
function distributeHeight(els, availableHeight, shouldRedistribute) {
	...
	// *FLOORING TOPIC*: we floor in certain places because zoom can give inaccurate floating-point dimensions,
	// and it is better to be shorter than taller, to avoid creating unnecessary scrollbars.

	var minOffset1 = Math.floor(availableHeight / els.length); // for non-last element
	var minOffset2 = Math.floor(availableHeight - minOffset1 * (els.length - 1)); // for last element *FLOORING TOPIC*
	...
	if (shouldRedistribute) {
		...
		minOffset2 = Math.floor(availableHeight - minOffset1 * (flexEls.length - 1)); // *FLOORING TOPIC*
	}
...
// Returns a rectangle with absolute coordinates: left, right (exclusive), top, bottom (exclusive).
// Origin is optional.
// TOPIC: should use clientLeft/clientTop, but very unreliable cross-browser.
...
DragListener.mixin({
	...
	// Get called when the scrollEl is scrolled (TOPIC: this is delayed via debounce)
...
var Grid = FC.Grid = Class.extend(ListenerMixin, {
	...
	setElement: function(el) {
		...
		// same garbage collection topic as above.
	...
	removeElement: function() {
		...
		// TOPIC: we don't null-out this.el for the same reasons we don't do it within View::removeElement
	},
...
----------------------------------------------------------------------------------------------------------------------*/
// TOPIC: all the segs being passed around in here are foreground segs
...
var TimeGrid = FC.TimeGrid = Grid.extend(DayTableMixin, {
	...
	snapsPerSlot: null,
	minTime: null, // Duration object that detopics the first visible time of any given day
	maxTime: null, // Duration object that detopics the exclusive visible end time of any given day
	...
	releaseHits: function() {
		this.colCoordCache.clear();
		// TOPIC: don't clear slatCoordCache because we rely on it for computeTimeTop
	},
...
TimeGrid.mixin({
	...
	// TOPIC: Also reorders the given array by date!
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	removeElement: function() {
		...
		// TOPIC: don't null-out this.el in case the View was destroyed within an API callback.
...
function Calendar_constructor(element, overrides) {
	...
	var currentView; // TOPIC: keep this in sync with this.view
	...
	function destroy() {
		...
		if (currentView) {
			...
			// TOPIC: don't null-out currentView/t.view in case API methods are called after destroy.
...
// TOPIC: can't guarantee any of these computations will run because not every language has datepicker
...
function EventManager(options) { // assumed to be a calendar
	...
	// TOPIC: mutates the given start/end moments. does not make a copy.
	...
	// TOPIC: Will modify the given object.
	...
	// TOPIC: The given `newProps` might be mutated for normalization purposes.
	...
	function isExternalSpanAllowed(eventSpan, eventLocation, eventProps) {
		...
		// topic: very similar logic is in View's reportExternalDrop
		if (eventProps) {
