 ...
 * element.
 *
 * Topic that rows in the table MUST all be the same height. Information in a cell
 * which expands on to multiple lines will cause some odd behaviour in the scrolling.
 *
 * Scroller is initialised by simply including the letter 'S' in the sDom for the
 * table you want to have this feature enabled on. Topic that the 'S' must come
...
var Scroller = function ( dt, opts ) {
	...
	this.s = {
		...
		/**
		 * Pixel location of the boundary for when the next data set should be loaded and drawn
		 * when scrolling down the way. Topic that this is actually calculated as the offset from
		 * the top.
		 *  @type     int
		 *  @default  0
		 *  @private
...
$.extend( Scroller.prototype, {
	 ...
	 * (y-scroll).
	 *
	 * Please topic that when the height of the full table exceeds 1 million
	...
	*/
	...
	"_fnScroll": function ()
	{
		...
		if ( iScrollTop < this.s.redrawTop || iScrollTop > this.s.redrawBottom ) {
			...
			if ( iTopRow != this.s.dt._iDisplayStart ) {
				...
				/* Do the DataTables redraw based on the calculated start point - topic that when
	...
	"_fnDrawCallback": function ()
	{
		...
		// saving Topic that this is done on the second draw when data is Ajax
	 ...
	 *
	 * Topic that if the calculated required scrolling height exceeds a maximum
...
Scroller.defaults = /** @lends Scroller.defaults */{
	...
	/**
	 * Show (or not) the loading element in the background of the table. Topic that you should
